...
class RegistrarAlarmaTableViewController: UITableViewController {
    
    var alarma : NSManagedObject?
     var accion : String!
    
    @IBOutlet var nombre: UITableView!
   ...
   @IBAction func guardarAlarmas( sender: UIBarButtonItem){
        ...
        let nombre = "alarmaTest"
        let frecuencia = "Tres al dia"
        let presentacion = "pastillas"
        let fecha = NSDate()
